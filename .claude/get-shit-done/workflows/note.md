...
- **Global scope**: `/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/notes/`)
...
2. Glob `/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/notes/` — works in any directory
