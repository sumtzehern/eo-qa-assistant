...
```
Task(
  prompt="Read /Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/get-shit-done/templates/VALIDATION.md`
