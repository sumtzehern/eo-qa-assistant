...
```
Task(
  prompt="Read /Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/wesleysum/Desktop/EdgeOne/Little Projects/edgeone-qa-assistant/.claude/get-shit-done/templates/SECURITY.md`
